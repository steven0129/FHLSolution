 ...
 * '創', '出', '利' ... '啟'
 */
export let CHINESE_BOOK_ABBREVIATIONS = [
    '創', '出', '利', '民', '申',
 ...
 * '创', '出', '利'...'启'
 */
export let CHINESE_BOOK_ABBREVIATIONS_GB = [
    '创', '出', '利', '民', '申',
 ...
 * '创世记', '出埃及记',...
 */
export let CHINESE_BOOK_NAMES_GB = [
 ...
 *  'Gen', 'Ex', 'Lev', 'Num', 'Deut',...
 */
export let ENGLISH_BOOK_ABBREVIATIONS = [
    'Gen', 'Ex', 'Lev', 'Num', 'Deut',
 ...
 * 'Ge', 'Ex', 'Le', 'Nu', 'De',...
 */
export let ENGLISH_BOOK_SHORT_ABBREVIATIONS = [
    'Ge', 'Ex', 'Le', 'Nu', 'De',
    'Jos', 'Jud', 'Ru', '1Sa', '2Sa',
